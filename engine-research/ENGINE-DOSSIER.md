...
- Injection vector that works (proxy DLL name / injector / framework): ⚠️ **NONE YET. The stage-1 `d3d9.dll` proxy STOPS THE GAME LAUNCHING** `[verified-live 2026-09-14, n=4 crashes / 2 clean runs]` — full A/B and evidence: `dev-archive/recon/2026-09-14-proxy-crash-ab-test/`.
